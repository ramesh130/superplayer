...
| `androidx.work:work-runtime` | Apache-2.0 | `superplayer-testkit` (compile only; ADR-0013 rule 11) |
...
| `androidx.work:work-testing` | Apache-2.0 | `superplayer-testkit` (compile only, and its own tests) |
